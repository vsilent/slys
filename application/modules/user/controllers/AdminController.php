 ...
 *
 * @version    $Id: AdminController.php 1309 2011-07-23 19:16:05Z jabberroid@gmail.com $
 */
...
class User_AdminController extends Zend_Controller_Action
{
    ...
    public function deleteUserAction()
    {
        ...
        $this->_helper->getHelper('FlashMessenger')->addMessage('User successfully deleted.');
        $this->_helper->getHelper('redirector')->goToRoute(array('module' => 'user', 'action' => 'users'), 'admin', true);
    }
    ...
    public function editRoleAction()
    {
        ...
        if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
            ...
            if($result)
                $this->_helper->getHelper('FlashMessenger')->addMessage('Role successfully saved.');
    ...
    public function deleteRoleAction()
    {
        ...
        $this->_helper->getHelper('FlashMessenger')->addMessage('Role successfully deleted.');
        $this->_helper->getHelper('redirector')->goToRoute(array('module' => 'user', 'action' => 'roles'), 'admin', true);
    }
